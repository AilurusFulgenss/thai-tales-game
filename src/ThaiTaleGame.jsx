...
const STORIES = [
  ...
  // ═══════════════════════════════════════════
  // ภาคอีสาน: ก่องข้าวน้อยฆ่าแม่
  // ═══════════════════════════════════════════
  {
    id: "isan",
    title: "ก่องข้าวน้อยฆ่าแม่",
    region: "ภาคอีสาน",
    regionColor: "#B8860B",
    emoji: "🌾",
    ...
    steps: [
      {
        ...
        text: "ชายหนุ่มชาวนาทำงานกลางทุ่งตั้งแต่เช้ามืด แดดเที่ยงแผดเผาจนเหงื่อท่วมตัว ท้องร้องจ๊อกๆ รอแม่เฒ่าเอาข้าวมาส่ง จนเห็นแม่เดินกะเผลกมาแต่ไกล มือถือก่องข้าวเล็กจิ๋วเท่าฝ่ามือ ลูกชายเห็นแล้วเริ่มรู้สึกไม่พอใจ",
        image: "/images/IMAGE_ISAN_01.png",
        choices: [
          { text: "โมโหจัด ตะโกนต่อว่าแม่ว่าข้าวแค่นี้จะพอกินเหรอ", path: "original", label: "★ เส้นทางออริจินัล" },
          { text: "พยายามข่มใจ อดทนรอเปิดก่องดูก่อน", path: "pathA" },
          { text: "วิ่งไปรับแม่ ช่วยพยุงเดิน ขอบคุณที่เดินมาไกล", path: "pathB" },
        ],
      },
      {
        id: 2,
        title: "ตอนที่ 2: ก่องข้าวน้อย",
        text: "แม่เฒ่ายื่นก่องข้าวน้อยให้ด้วยรอยยิ้ม ลูกชายจ้องมองก่องเล็กกระจิดริด คิดในใจว่ากินคำเดียวก็คงหมด ทำนาเหนื่อยแทบตาย แม่ทำอาหารมาให้แค่นี้เอง แม่เอ่ยเสียงอ่อนว่า \"ลองเปิดดูก่อนนะลูก\"",
        image: "/images/IMAGE_ISAN_02.png",
        choices: [
          { text: "ปัดมือแม่ออก ไม่สนใจ ด่าว่าแม่ตระหนี่", path: "original", label: "★ เส้นทางออริจินัล" },
          { text: "หยุดคิดสักครู่ ค่อยๆ เปิดฝาก่องดู", path: "pathA" },
          { text: "รับก่องมาเบาๆ ถามแม่ว่ากินข้าวหรือยัง", path: "pathB" },
        ],
      },
      {
        id: 3,
        title: "ตอนที่ 3: ชั่วขณะแห่งความโกรธ",
        text: "ความหิวและความโกรธเข้าครอบงำจิตใจ ลูกชายหยิบเคียวเกี่ยวข้าวขึ้นมา มือสั่น สายตามืดมน แม่เฒ่าถอยหลังด้วยความตกใจ ร้องเรียกชื่อลูกด้วยเสียงสั่นเครือ \"ลูก... ฟังแม่ก่อน... ก่องข้าวนี้มันไม่ธรรมดา...\"",
        image: "/images/IMAGE_ISAN_03.png",
        choices: [
          { text: "ไม่ฟังเสียงแม่ ลงมือทำร้ายแม่ด้วยความโกรธ", path: "original", label: "★ เส้นทางออริจินัล" },
          { text: "ยั้งมือไว้ได้ทัน วางเคียวลง หยิบก่องข้าวขึ้นมาเปิด", path: "pathA" },
          { text: "ร้องไห้ออกมา ทิ้งเคียว คุกเข่าลงกอดแม่ขอโทษ", path: "pathB" },
        ],
      },
      {
        id: 4,
        title: "ตอนที่ 4: ความจริงในก่อง",
        text: "ก่องข้าวเปิดออก... ข้าวในก่องน้อยนิดก็จริง แต่เมื่อตักกินคำแรก ข้าวก็เพิ่มขึ้นมาเอง ตักเท่าไรก็ไม่มีวันหมด! นี่คือข้าววิเศษที่แม่ตั้งใจหุงด้วยความรักทั้งหมดที่มี ความจริงปรากฏต่อหน้า ทุกอย่างชัดเจน",
      ...
      },
      {
        ...
        text: "ลมหอบเอาเมฆดำมาปกคลุมทุ่งนา ราวกับท้องฟ้าร้องไห้แทน ชายหนุ่มนั่งนิ่งอยู่กลางทุ่ง มองก่องข้าววิเศษ และนึกถึงทุกสิ่งที่เกิดขึ้น",
    ...
    endings: {
      original: {
        ...
        text: "ชายหนุ่มเพิ่งรู้ความจริงเมื่อสายเกินไป ข้าวในก่องน้อยนั้นกินไม่มีวันหมด เป็นข้าววิเศษที่แม่ตั้งใจหุงให้ด้วยหัวใจทั้งดวง แต่เขาทำร้ายแม่ไปแล้วด้วยความโกรธที่ไร้เหตุผล ชายหนุ่มร้องไห้คลุกฝุ่น กอดก่องข้าวไว้แน่น ตั้งแต่นั้นเขาไม่เคยยิ้มอีกเลย เดินบอกเล่าเรื่องราวของตัวเองให้คนทั้งหมู่บ้านฟัง เพื่อไม่ให้ใครทำผิดซ้ำ",
      ...
      pathA: {
        ...
        text: "ชายหนุ่มยั้งมือไว้ได้ทัน วางเคียวลงแล้วเปิดก่องข้าว เมื่อเห็นข้าววิเศษที่กินไม่หมด น้ำตาไหลพราก เขากอดแม่เฒ่าไว้แน่น ร้องไห้ขอโทษ ตั้งแต่วันนั้นเขาไม่เคยโกรธแม่อีกเลย ทำงานหนักเพื่อดูแลแม่จนวันสุดท้ายของชีวิต",
      ...
      pathB: {
        ...
        text: "ชายหนุ่มรับก่องข้าวจากแม่ด้วยความขอบคุณ พอเปิดก่องเห็นข้าวน้อยนิดก็ไม่ว่าอะไร ตักให้แม่กินก่อน แล้วค่อยกินเอง ปาฏิหาริย์เกิดขึ้น ข้าวในก่องไม่มีวันหมด สองแม่ลูกกินอิ่มหนำ นั่งพักใต้ร่มไม้กลางทุ่ง หัวเราะร่วมกัน ก่องข้าวน้อยกลายเป็นสมบัติล้ำค่าของครอบครัว",
